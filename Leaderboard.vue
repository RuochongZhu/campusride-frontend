  ...
  <header class="fixed top-0 left-0 right-0 bg-[#EDEEE8] shadow-sm z-50">
    <div class="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
      <div class="flex items-center space-x-4">
        <a href="/" class="flex items-center text-[#C24D45]">
      ...
      <div class="flex items-center space-x-4">
        <a-select v-model:value="timePeriod" class="w-40 !rounded-button">
        ...
        <a-button class="!rounded-button whitespace-nowrap" @click="refreshData">
          ...
          <div v-for="winner in topWinners" :key="winner.rank" 
            ...
            <div class="bg-white rounded-lg p-4 text-center relative">
              <div class="absolute -top-12 left-1/2 transform -translate-x-1/2">
                ...
                <div :class="['absolute -top-4 -right-4 w-8 h-8 rounded-full flex items-center justify-center text-white font-bold',
...
import { ref } from 'vue';
import { LeftOutlined, SyncOutlined, TrophyOutlined, ArrowUpOutlined, ArrowDownOutlined, MinusOutlined } from '@ant-design/icons-vue';
...
const rankings = ref([
  ...
  },
  {
    ...
    points: 2750,
    rankChange: 0,
    avatar: 'https://public.readdy.ai/ai/img_res/62b06f4bd2d315327fd61b2d922b62db.jpg'
  }
]);
...
:deep(.ant-select-item-option-selected:not(.ant-select-item-option-disabled)) {
  background-color: rgba(194, 77, 69, 0.1);
}
</style>
