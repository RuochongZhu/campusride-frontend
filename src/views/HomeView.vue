...
<!-- Hero Section -->
<section class="pb-16 bg-gradient-to-r from-[#C24D45] to-[#63B5B7] text-white relative overflow-hidden">
...
<button class="bg-white text-[#C24D45] px-6 py-3 hover:bg-[#EDEEE8] rounded-md transition-colors duration-300">Get Started</button>
</router-link>
</div>
</swiper-slide>
</swiper>
...
link: '/leaderboard'  // 修改为Vue Router路径
},
{
...
link: '/activities'  // 修改为Vue Router路径
},
{
...
link: '/rideshare'  // 修改为Vue Router路径
},
{
...
link: '/marketplace'  // 修改为Vue Router路径
}
]
